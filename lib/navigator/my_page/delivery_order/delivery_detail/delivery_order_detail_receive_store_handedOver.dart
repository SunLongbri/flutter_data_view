...
//我收到的交接单 已交接 门店至干线
class DeliveryOrderDetailReceiveStoreHandedOver extends StatefulWidget {
  String deliveryOrderModelString;//交接单model
  DeliveryOrderDetailReceiveStoreHandedOver({Key key,this.deliveryOrderModelString}):super(key:key);
  @override
  _DeliveryOrderDetailReceiveStoreHandedOverState createState() => _DeliveryOrderDetailReceiveStoreHandedOverState();
}

class _DeliveryOrderDetailReceiveStoreHandedOverState extends State<DeliveryOrderDetailReceiveStoreHandedOver> {
