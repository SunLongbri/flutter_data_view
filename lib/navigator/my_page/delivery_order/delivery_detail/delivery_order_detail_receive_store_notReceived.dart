...
//我收到的交接单 待接收 门店至干线
class DeliveryOrderDetailReceiveStoreNotReceived extends StatefulWidget {
  String deliveryOrderModelString;//交接单model
  DeliveryOrderDetailReceiveStoreNotReceived({Key key,this.deliveryOrderModelString}):super(key:key);
  @override
  _DeliveryOrderDetailReceiveStoreNotReceivedState createState() => _DeliveryOrderDetailReceiveStoreNotReceivedState();
}

class _DeliveryOrderDetailReceiveStoreNotReceivedState extends State<DeliveryOrderDetailReceiveStoreNotReceived> {
