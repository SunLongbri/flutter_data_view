...
//我发起的交接单 待交接 干线到工厂
class DeliveryOrderDetailInitiateFactoryNotReceived extends StatefulWidget {
  String deliveryOrderModelString;//交接单model
  DeliveryOrderDetailInitiateFactoryNotReceived({Key key,this.deliveryOrderModelString}):super(key:key);
  @override
  _DeliveryOrderDetailInitiateFactoryNotReceivedState createState() => _DeliveryOrderDetailInitiateFactoryNotReceivedState();
}

class _DeliveryOrderDetailInitiateFactoryNotReceivedState extends State<DeliveryOrderDetailInitiateFactoryNotReceived> {
