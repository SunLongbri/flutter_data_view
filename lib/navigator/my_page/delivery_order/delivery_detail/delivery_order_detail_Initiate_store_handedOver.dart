...
//我发起的交接单 已交接 干线到门店
class DeliveryOrderDetailInitiateStoreHandedOver extends StatefulWidget {
  String deliveryOrderModelString;//交接单model
  DeliveryOrderDetailInitiateStoreHandedOver({Key key,this.deliveryOrderModelString}):super(key:key);
  @override
  _DeliveryOrderDetailInitiateStoreHandedOverState createState() => _DeliveryOrderDetailInitiateStoreHandedOverState();
}

class _DeliveryOrderDetailInitiateStoreHandedOverState extends State<DeliveryOrderDetailInitiateStoreHandedOver> {
