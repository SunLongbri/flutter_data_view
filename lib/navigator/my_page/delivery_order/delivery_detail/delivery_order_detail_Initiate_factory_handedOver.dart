...
//我发起的交接单 已交接 干线到工厂
class DeliveryOrderDetailInitiateFactoryHandedOver extends StatefulWidget {
  String deliveryOrderModelString;//交接单model
  DeliveryOrderDetailInitiateFactoryHandedOver({Key key,this.deliveryOrderModelString}):super(key:key);
  @override
  _DeliveryOrderDetailInitiateFactoryHandedOverState createState() => _DeliveryOrderDetailInitiateFactoryHandedOverState();
}

class _DeliveryOrderDetailInitiateFactoryHandedOverState extends State<DeliveryOrderDetailInitiateFactoryHandedOver> {
