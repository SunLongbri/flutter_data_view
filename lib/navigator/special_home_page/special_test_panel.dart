...
class SpecialTestPanel extends StatefulWidget {
  @override
  _SpecialTestPanelState createState() => _SpecialTestPanelState();
}

class _SpecialTestPanelState extends State<SpecialTestPanel> {
